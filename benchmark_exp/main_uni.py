...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=args.n_jobs)(delayed(eval_one)(filename, args) for filename in file_list if filename not in Resume_file_name_list)